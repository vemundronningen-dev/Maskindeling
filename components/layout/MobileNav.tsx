  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50">
      <div className="flex justify-around py-2">
        <Link
          href="/dashboard"
          className="flex flex-col items-center gap-1 text-gray-600 hover:text-blue-700 px-3 py-1"
        >
        ...
        >
          ...
          <span className="text-xs">Maskiner</span>
        </Link>
        <Link
          href="/foresporsler"
          className="flex flex-col items-center gap-1 text-gray-600 hover:text-blue-700 px-3 py-1"
        >
          ...
          <span className="text-xs">Forespørsler</span>
        </Link>
        {user.role === "admin" && (
          <Link
            href="/admin"
